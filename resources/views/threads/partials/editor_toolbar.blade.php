<div class="editor-toolbar">
  <div class="opts pull-right">
    <span class="dropdown dropdown-small" id="editor-toolbar-insert-code">
      <a href="#editor-toolbar-insert-code" data-toggle="dropdown" title="{{ trans('threads.partials.editor_toolbar.insert_code') }}"><i class="fa fa-code"></i></a>
    ...
    <a class="btn-upload" href="javascript:void(0);" data-toggle="tooltip" data-placement="bottom" title="{{ trans('threads.partials.editor_toolbar.upload_image') }}"><i class="fa fa-image"></i> </a>
    <input type="file" name="file" class="input-file" style="display: none;" />
  </div>
  <ul class="nav nav-pills" style="clear:none;">
    <li class="edit active"><a href="#">{{ trans('threads.partials.editor_toolbar.edit') }}</a></li>
    <li class="preview"><a href="#">{{ trans('threads.partials.editor_toolbar.preview') }}</a></li>
  </ul>
</div>